...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on 
<port> (default: 27393 or testnet: 27383)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections 
on <port> (default: 27392 or testnet: 27832)") + "\n" +
