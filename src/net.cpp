...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tocointools.com", "dnsseed.tocointools.com"},
    {"tocoinpool.org", "dnsseed.tocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"tocointools.com", "testnet-seed.tocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tocoin is probably already running."), addrBind.ToString().c_str());
        else
